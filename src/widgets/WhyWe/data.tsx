    ...
    text: (
      <>
        <p>
          ...
          стал незаменимым в нашей жизни, и поэтому наш сервис работает внутри
          приложения для вашего удобства.
        </p>
        <p>
          И никаких звонков от операторов! Отчет по заявке собирается через
          бота в удобной форме
        </p>
      </>
    ),
    image: girl1,
