        ...
        <div className={styles.previousLessons}>
            ...
            <LessonsList status='unpaid'>
                {lessonsListUnpaid.map((lesson, index) => (
                    <Lesson key={index} lessonNumber={lesson.lessonNumber} lessonPrice={lesson.lessonPrice} lessonData={lesson.lessonData} lessonTime={lesson.lessonTime} lessonDebt={lesson.lessonDebt}></Lesson>
                ))}
            </LessonsList>
            <div className={styles.previousLessons__divider}></div>
            <LessonsList status='paid'>
                {lessonsListPaid.map((lesson, index) => (
                    <Lesson key={index} lessonNumber={lesson.lessonNumber} lessonPrice={lesson.lessonPrice} lessonData={lesson.lessonData} lessonTime={lesson.lessonTime}></Lesson>
                ))}
            </LessonsList>
        </div>
    )
