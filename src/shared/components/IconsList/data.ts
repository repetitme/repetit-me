...
export const iconSources = {
  student: [
    {
      src: 'src/assets/images/StudentIcons/loupe.png',
      className: styles.loupe
    },
    {
      src: 'src/assets/images/StudentIcons/toggle.png',
      className: styles.toggle
    },
    { src: 'src/assets/images/StudentIcons/cone.png', className: styles.cone },
    {
      src: 'src/assets/images/StudentIcons/bubble.png',
  ...
  teacher: [
    {
      src: 'src/assets/images/TeacherIcons/triangle.png',
    ...
    {
      src: 'src/assets/images/TeacherIcons/spiral.png',
