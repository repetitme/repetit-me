  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <Popup
        ...
        text="Отклик отправлен успешно! Когда преподаватель примет заявку мы обменяем Вас контактами в Telegram, уведомление прийдёт автоматически через бота.Отменить или посмотреть статус заявки можно 
